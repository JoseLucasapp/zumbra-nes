...
## 0.5.43 — in-window controls and Xbox gamepad
...
- Preserve runtime-editable controller mapping from 0.5.43.

# 0.5.43 - input settings hotfix
...
## 0.5.43 — smooth-frame fast PPU and Zumbra 0.14.5
...
## 0.5.43 — scheduler de frame, ajuda e CI por versão
