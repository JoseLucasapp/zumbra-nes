...
## 0.5.59 — in-window controls and Xbox gamepad
...
- Preserve runtime-editable controller mapping from 0.5.59.

# 0.5.59 - input settings hotfix
...
## 0.5.59 — smooth-frame fast PPU and Zumbra 0.14.5
...
## 0.5.59 — scheduler de frame, ajuda e CI por versão
