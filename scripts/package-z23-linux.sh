...
# Keep packaged local builds aligned with the gate performance profile.
...
appdir="$output_dir/zumbra-nes-0.5.44-linux-${arch}.AppDir"
deb="$output_dir/zumbra-nes_0.5.44_${arch}.deb"
...
grep -q ' Version: 0.5.44' build/deb-info.txt
